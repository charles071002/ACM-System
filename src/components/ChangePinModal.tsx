        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="space-y-2">
              <label className="block text-[10px] font-black text-blue-900 uppercase tracking-widest text-center">New PIN Code</label>
              <input
                type="password"
                maxLength={6}
                value={newPin}
            ...
            <div className="space-y-2">
              <label className="block text-[10px] font-black text-blue-900 uppercase tracking-widest text-center">Re-enter PIN Code</label>
              <input
                type="password"
                maxLength={6}
                value={confirmPin}
            ...
            <button
              ...
              className={`w-full py-4 rounded-2xl font-black text-sm uppercase tracking-widest shadow-lg transition-all flex items-center justify-center gap-3 ${newPin.length < 6 || confirmPin.length < 6 ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-blue-900 text-yellow-400 hover:bg-blue-800 active:scale-95 border-b-4 border-yellow-600'}`}
            >
