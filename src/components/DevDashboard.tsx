...
import { 
  ChevronLeft, Shield, Edit3, RotateCcw, Save, X, 
  GraduationCap, AlertTriangle, Check, Menu as MenuIcon, QrCode, Box
} from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white overflow-hidden relative">
      <header className="bg-blue-900 border-b-4 border-yellow-500 p-6 flex flex-col items-center justify-center relative flex-shrink-0">
        ...
        <p className="text-[10px] font-bold text-yellow-500/80 uppercase tracking-widest mt-1">Developer Admin Interface</p>
      </header>
        ...
        <div className="w-full max-w-5xl mx-auto relative pt-4">
          ...
          <div className="w-full max-w-2xl mx-auto space-y-6 mt-4">
            <div className="flex items-center justify-between px-2">
              ...
              <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">{profs.length} Active Nodes</span>
            </div>

            <div className="space-y-3" ref={menuRef}>
            {profs.map((prof) => (
              <div key={prof.id} className="bg-blue-50 border-2 border-blue-100 rounded-3xl p-4 shadow-sm animate-fade-in flex flex-col gap-4 relative">
                  ...
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    {editingId === prof.id ? (
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] font-bold text-yellow-600 mt-1 uppercase tracking-wider">{prof.department} DEPARTMENT</span>
                      </div>
                    )}
                  </div>
                  ...
                  {editingId !== prof.id && (
                    <div className="relative">
                      <button 
                        ...
                        className={`p-2 rounded-xl transition-all ${openMenuId === prof.id ? 'bg-yellow-500 text-blue-900 shadow-inner' : 'text-blue-900 hover:bg-blue-100'}`}
                      >
                        <MenuIcon size={24} />
                      </button>
          ...
          <div className="py-8 text-center">
            <p className="text-[9px] font-black text-gray-300 uppercase tracking-widest leading-relaxed">
              ACM SYSTEM V2.5.0 CLOUD SYNC: DISABLED<br/>
      ...
      {editingCompartment && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-[2.5rem] w-full max-w-sm overflow-hidden shadow-2xl animate-scale-up border-4 border-yellow-500">
            ...
            <div className="p-8">
              <label className="block text-[10px] font-black text-blue-900 uppercase tracking-widest mb-2 px-1">Override Data (Default: Name)</label>
              <textarea
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-[2.5rem] w-full max-w-sm overflow-hidden shadow-2xl animate-scale-up border-4 border-yellow-500">
            ...
            <div className="p-8 text-center">
              <p className="text-blue-900 font-bold text-sm leading-relaxed mb-8">
                This action will reset the PIN
              </p>
